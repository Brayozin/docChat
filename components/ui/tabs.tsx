...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div className="relative" ref={tabsListRef}>
      <div
        className="absolute rounded-full bg-rose-200 shadow-md transition-all duration-300 ease-in-out pointer-events-none z-0"
        style={indicatorStyle}
      />
      <TabsPrimitive.List
        ref={ref}
        className={cn(
          "relative inline-flex items-center justify-center rounded-md bg-muted p-1 text-muted-foreground z-10",
          className
        )}
        {...props}
      />
